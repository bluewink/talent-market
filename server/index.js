...
//코인 업데이트
app.post("/api/users/updateCoin", (req, res) => {
  console.log("coin update start");
  ...
  User.findOne({ email: req.body.email }, (err, user) => {
    ...
    //있다면, 업데이트된 코인 넣어주기
    console.log("coin from db : ", user.coin);
    console.log("new coin : ", req.body.coin);
    ...
    res.status(200).json({ updateCoinSuccess: true, email: user.email });
